...
public class CategoriaController implements Serializable {
    ...
    private CategoriaJpaControllerExt jpaController = null;
    ...
    private CategoriaJpaControllerExt getJpaController() {
        if (jpaController == null) {
            jpaController = new CategoriaJpaControllerExt(LittleLiguesUtils.getEmf());
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getCategoriaCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findCategoriaEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getCategoriaCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findCategoriaEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findCategoriaEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findCategoriaEntities(), true);
    }
    ...
    public static class CategoriaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findCategoria(getKey(value));
        }
